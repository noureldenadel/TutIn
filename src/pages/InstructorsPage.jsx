...
import { getAllCourses, getInstructorAvatarAsync, setInstructorAvatar, formatDuration } from '../utils/db'
...
function InstructorsPage() {
    ...
    function handleAvatarClick(e, instructorName) {
        e.preventDefault()
        e.stopPropagation()
        setAvatarUploadTarget(instructorName)
    ...
    async function handleAvatarFileChange(e) {
        ...
        try {
            ...
            reader.onload = async (event) => {
                // Resize image to 200x200 for storage efficiency
                const img = new Image()
                img.onload = async () => {
                    ...
                    await setInstructorAvatar(avatarUploadTarget, base64)

                    // Update local state immediately
                    setInstructorAvatars(prev => ({
                        ...prev,
                        [avatarUploadTarget]: base64
                    }))
        ...
        <div className="py-6">
            ...
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-gray-900 dark:text-white flex items-center gap-3">
                    <Users className="w-7 h-7 text-primary-fg" />
                    Instructors
                </h1>
            ...
            {filterInstructor && selectedInstructor && (
                <div className="mb-6 p-4 bg-primary/5 rounded-xl border border-blue-200 dark:border-primary/20 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <button
                            onClick={(e) => handleAvatarClick(e, selectedInstructor.name)}
                        ...
                        >
                            {selectedInstructor.avatar ? (
                                ...
                                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-500 to-blue-600 flex items-center justify-center ring-2 ring-blue-200 dark:ring-primary/30">
                            ...
                            <div className="aspect-video bg-gray-100 dark:bg-dark-bg relative overflow-hidden">
                                ...
                                {course.completionPercentage > 0 && (
                                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-black/30">
                                        <div
                                            className="h-full bg-primary-fg text-primary-content"
                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex justify-center mb-5">
                                            <button
                                                onClick={(e) => handleAvatarClick(e, instructor.name)}
                                            ...
                                            >
                                                {instructor.avatar ? (
                                                    ...
                                                    <div className="w-20 h-20 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center ring-4 ring-gray-100 dark:ring-dark-bg group-hover:ring-blue-100 dark:group-hover:ring-primary/20 transition-all">
                                        ...
                                        {instructor.totalVideos > 0 && (
                                            <div className="mt-2">
                                                <div className="flex justify-between items-center text-xs mb-1.5">
                                                    ...
                                                    <span className="font-medium text-primary-fg">{progressPercent}%</span>
                                                </div>
